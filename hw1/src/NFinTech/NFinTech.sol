...
contract NFinTech is IERC721 {
    ...
    function setApprovalForAll(address operator, bool approved) external {
        ...
        require(operator != address(0), "operator doesn't exist");
    ...
    require(
        to.code.length == 0 || IERC721TokenReceiver(to).onERC721Received(msg.sender, from, tokenId, "") == IERC721TokenReceiver.onERC721Received.selector, "unsafe recipient" );
    }
}
